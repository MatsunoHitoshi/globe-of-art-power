  ...
  results: [
    {
      hits: [
        ...
        },
        {
          ...
          nationality: { name: "US" },
          power_100_edition: [{ name: "2016" }, { name: "2017" }],
          acf: {
            artist_power_100: [
              { place: 43, edition: { wordpress_id: 17, name: "2017" } },
              { place: 84, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Nato-Thompson-squae.jpg",
            caption: "Nato Thompson. Courtesy Creative Time, New York",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          path: "/artist/ragnar-kjartansson/",
          content:
          ...
          excerpt: "Artist crooning across the world",
          artist_category: { name: "Artist" },
          nationality: { name: "IS" },
          power_100_edition: [{ name: "2016" }],
          acf: {
            artist_power_100: [
              { place: 100, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Ragnar-Kjartansson-square.jpg",
            caption: "Ragnar Kjartansson. Photo: Elisabet Davids",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          modified: "2024-12-05T12:19:52.000Z",
          objectID: "15041",
          _highlightResult: {
            title: {
        ...
        },
        {
          ...
          excerpt: "Supporting Turkey’s art scene and more",
          artist_category: { name: "Collector" },
          nationality: { name: "TR" },
          power_100_edition: [{ name: "2016" }],
          acf: {
            artist_power_100: [
              { place: 99, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/omer_M_Koc.jpg",
            caption: "Ömer Koç. Licensed under Creative Commons: Ayberksz is",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          objectID: "15040",
          _highlightResult: {
            title: { value: "Ömer Koç", matchLevel: "none", matchedWords: [] },
          },
        },
        {
        ...
        },
        {
          ...
          excerpt: "Artist meditating on emotions in our digital-age",
          artist_category: { name: "Artist" },
          nationality: { name: "GB" },
          power_100_edition: [{ name: "2016" }],
          acf: {
            artist_power_100: [
              { place: 50, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/EdAtkins-square.jpg",
            caption: "Ed Atkins. Photo: Andrea Guermani",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          modified: "2024-12-05T12:19:48.000Z",
          objectID: "15032",
          _highlightResult: {
            title: { value: "Ed Atkins", matchLevel: "none", matchedWords: [] },
          },
        },
        {
          title: "Sheena Wagstaff",
          path: "/artist/sheena-wagstaff/",
          content:
          ...
          acf: {
            artist_power_100: [
              { place: 48, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Sheena-Wagstaff-square.jpg",
            caption: "Sheena Wagstaff. Photo: Samantha Nandez / BFA",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          excerpt: "'Social Sculpture' pioneer",
          artist_category: { name: "Artist" },
          nationality: { name: "US" },
          power_100_edition: [{ name: "2015" }, { name: "2016" }],
          acf: {
            artist_power_100: [
              { place: 89, edition: { wordpress_id: 16, name: "2016" } },
              { place: 89, edition: { wordpress_id: 15, name: "2015" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Rick-Lowe-square.jpg",
            caption: "Rick Lowe. Courtesy Project Row Houses, Houston",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          objectID: "13554",
          _highlightResult: {
            title: { value: "Rick Lowe", matchLevel: "none", matchedWords: [] },
          },
        },
        {
          title: "Bernard Blistène & Serge Lasvignes",
          path: "/artist/bernard-blistne-serge-lasvignes/",
          content:
          ...
          excerpt: "Director and president of Centre Pompidou",
          artist_category: { name: "Museum Director" },
          nationality: { name: "FR" },
          power_100_edition: [{ name: "2015" }, { name: "2016" }],
          acf: {
            artist_power_100: [
              { place: 18, edition: { wordpress_id: 16, name: "2016" } },
              { place: 15, edition: { wordpress_id: 15, name: "2015" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/B-S-square.jpg",
            caption:
              "Bernard Blistène\n& Serge Lasvignes. Photo: Hervé Véronèse",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          modified: "2024-12-05T12:19:53.000Z",
          objectID: "13549",
          _highlightResult: {
            title: {
              value: "Bernard Blistène & Serge Lasvignes",
              matchLevel: "none",
              matchedWords: [],
            },
          },
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 66, edition: { wordpress_id: 19, name: "2019" } },
              { place: 87, edition: { wordpress_id: 17, name: "2017" } },
              { place: 82, edition: { wordpress_id: 16, name: "2016" } },
              { place: 83, edition: { wordpress_id: 15, name: "2015" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Trevor_Paglen_square.jpg",
            caption: "Trevor Paglen. Photo: Studio Paglen",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        {
          title: "Riyas Komu & Bose Krishnamachari",
          path: "/artist/riyas-komu-bose-krishnamachari/",
          content:
          ...
          excerpt: "Artist-founders of India’s Kochi-Murziris Biennale",
          artist_category: { name: "Artist" },
          nationality: { name: "IN" },
          power_100_edition: [{ name: "2016" }, { name: "2017" }],
          acf: {
            artist_power_100: [
              { place: 84, edition: { wordpress_id: 17, name: "2017" } },
              { place: 83, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Komu-Krishnamachari-square.jpg",
            caption:
              "Riyas Komu & Bose\nKrishnamachari. Courtesy Kochi-Muziris Biennale Foundation",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          _highlightResult: {
            title: {
              value: "Riyas Komu & Bose Krishnamachari",
              matchLevel: "none",
              matchedWords: [],
            },
          },
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 86, edition: { wordpress_id: 17, name: "2017" } },
              { place: 65, edition: { wordpress_id: 16, name: "2016" } },
              { place: 77, edition: { wordpress_id: 12, name: "2012" } },
              { place: 75, edition: { wordpress_id: 11, name: "2011" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/WGR_square.jpg",
            caption:
              "Walid Raad. Courtesy the artist and Sfeir-Semler Gallery, Beirut",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 44, edition: { wordpress_id: 17, name: "2017" } },
              { place: 71, edition: { wordpress_id: 16, name: "2016" } },
              { place: 85, edition: { wordpress_id: 6, name: "2006" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Hou_Hanru_square.jpg",
            caption:
              "Hou Hanru. Photo: Musacchio Ianniello. Courtesy Fondazione MAXXI, Rome",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          objectID: "12757",
          _highlightResult: {
            title: { value: "Hou Hanru", matchLevel: "none", matchedWords: [] },
          },
        },
        {
        ...
        {
          title: "Matthew Slotover, Amanda Sharp & Victoria Siddall",
          path: "/artist/matthew-slotover-amanda-sharp-victoria-siddall/",
          content:
          ...
          acf: {
            artist_power_100: [
              { place: 66, edition: { wordpress_id: 16, name: "2016" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Slotover-Sharp-square2.jpg",
            caption:
              "Matthew Slotover,\nAmanda Sharp & Victoria Siddall. Photo: Jonathan Hökklo. Courtesy Frieze, London",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          modified: "2024-12-05T12:19:49.000Z",
          objectID: "12663",
          _highlightResult: {
            title: {
              value: "Matthew Slotover, Amanda Sharp & Victoria Siddall",
              matchLevel: "none",
              matchedWords: [],
            },
          },
      ...
      facets: {
        title: {
          ...
          "Beatrix Ruf": 1,
          "Bernard Arnault": 1,
          "Bernard Blistène & Serge Lasvignes": 1,
          ...
          "Massimo De Carlo": 1,
          "Matthew Marks": 1,
          "Matthew Slotover, Amanda Sharp & Victoria Siddall": 1,
          "Michael Govan": 1,
          "Miuccia Prada": 1,
          ...
          "Riyas Komu & Bose Krishnamachari": 1,
          "Sadie Coles": 1,
          "Sheena Wagstaff": 1,
      ...
      query: "",
      params:
        "highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&facetFilters=%5B%22power_100_edition.name%3A2016%22%5D&hitsPerPage=100&facets=%5B%22title%22%2C%22artist_category.name%22%2C%22power_100_edition.name%22%2C%22nationality.name%22%5D&tagFilters=",
