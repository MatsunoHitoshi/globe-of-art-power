  ...
  results: [
    {
      hits: [
        ...
        },
        {
          ...
          nationality: { name: "IN" },
          power_100_edition: [{ name: "2017" }, { name: "2024" }],
          acf: {
            artist_power_100: [
              { place: 70, edition: { wordpress_id: 4162, name: "2024" } },
              { place: 99, edition: { wordpress_id: 17, name: "2017" } },
            ],
          },
          featured_media: {
            source_url:
        ...
        },
        {
          ...
          excerpt: "American novelist and critic ",
          artist_category: { name: "Writer" },
          nationality: { name: "US" },
          power_100_edition: [{ name: "2017" }],
          acf: {
            artist_power_100: [
              { place: 77, edition: { wordpress_id: 17, name: "2017" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/ckraus-square.jpg",
            caption:
              "Chris Kraus. Courtesy MIT Press, Cambridge (Massachusetts)",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        {
          title: "Elena Filipovic",
          path: "/artist/elena-filipovic/",
          content:
          ...
          excerpt: "Dynamic director of Kunsthalle Basel",
          artist_category: { name: "Curator" },
          nationality: { name: "US" },
          power_100_edition: [
            { name: "2011" },
          ...
          acf: {
            artist_power_100: [
              { place: 62, edition: { wordpress_id: 17, name: "2017" } },
              { place: 68, edition: { wordpress_id: 12, name: "2012" } },
              { place: 89, edition: { wordpress_id: 11, name: "2011" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Elena_Filipovic_square.jpg",
            caption: "Elena Filipovic. Photo: Natalia Evelyn Bencicova",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
      ...
      query: "",
      params:
        "highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&facetFilters=%5B%22power_100_edition.name%3A2017%22%5D&hitsPerPage=100&facets=%5B%22title%22%2C%22artist_category.name%22%2C%22power_100_edition.name%22%2C%22nationality.name%22%5D&tagFilters=",
