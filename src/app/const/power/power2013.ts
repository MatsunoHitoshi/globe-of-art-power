export const power2013 = {
  results: [
    {
      hits: [
        {
          title: "Zhang Wei",
          path: "/artist/zhang-wei/",
          content:
          ...
          excerpt: "Imagining a different model with Vitamin Creative Space",
          artist_category: { name: "Gallerist" },
          nationality: { name: "CN" },
          power_100_edition: [{ name: "2013" }],
          acf: {
            artist_power_100: [
              { place: 91, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2020/04/zhangwei-280x280-1.jpg",
            caption: "Zhang Wei. Photo: Hu Fang",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          objectID: "29879",
          _highlightResult: {
            title: { value: "Zhang Wei", matchLevel: "none", matchedWords: [] },
          },
        },
        {
        ...
        {
          title: "Dasha Zhukhova",
          path: "/artist/dasha-zhukova-1/",
          content:
          ...
          excerpt:
            "Founder of Moscow's private art foundation the Garage Museum of Contemporary Art",
          ...
          acf: {
            artist_power_100: [
              { place: 98, edition: { wordpress_id: 16, name: "2016" } },
              { place: 97, edition: { wordpress_id: 15, name: "2015" } },
              { place: 86, edition: { wordpress_id: 13, name: "2013" } },
              { place: 85, edition: { wordpress_id: 12, name: "2012" } },
              { place: 81, edition: { wordpress_id: 11, name: "2011" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Dasha-Zhukova-square.jpg",
            caption:
              "Dasha Zhukova. Courtesy Garage Museum of Contemporary Art, Moscow",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 90, edition: { wordpress_id: 13, name: "2013" } },
              { place: 91, edition: { wordpress_id: 12, name: "2012" } },
              { place: 98, edition: { wordpress_id: 11, name: "2011" } },
            ],
          },
          featured_media: null,
          modified: "2024-12-05T12:20:39.000Z",
          objectID: "12789",
          _highlightResult: {
            title: {
              value: "Franco Noero",
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 100, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Eko-Nugroho-280x280-1.jpg",
            caption: "Eko Nugroho. Courtesy Eko Nugroho",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 98, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/El-Anatsui-280x280-1.jpg",
            caption:
              "El Anatsui. Courtesy El Anatsui and Jack Shainman Gallery",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 93, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/forrest-nash-280x280-1.jpg",
            caption: "Forrest Nash. Courtesy Forrest Nash",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 89, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Sean-Kelly-280x280-1.jpg",
            caption: "Sean Kelly. Photo: Steve Benisty",
            alt_text: "",
            media_details: {
              width: 1200,
              height: 1200,
              sizes: {
                thumbnail: {
                  source_url:
                    "https://backend.artreview.com/wp-content/uploads/2019/11/Sean-Kelly-280x280-1-300x300.jpg",
                  width: 300,
                  height: 300,
                },
                medium: {
                  source_url:
                    "https://backend.artreview.com/wp-content/uploads/2019/11/Sean-Kelly-280x280-1-600x600.jpg",
                  width: 600,
                  height: 600,
                },
                large: null,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 83, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Zeng-Fanzhi-280x280-1.jpg",
            caption: "Zeng Fanzhi. Courtesy Fanzhi Studio",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          acf: {
            artist_power_100: [
              { place: 80, edition: { wordpress_id: 13, name: "2013" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Bard-280x280-1.jpg",
            caption:
              "CCS Bard, Annandale-on-Hudson. Mark Handforth, Wishbone, 2010; Franz West, Couch, 2004. Photo: Chris Kendall",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
        ...
        },
        {
          ...
          artist_category: null,
          nationality: null,
          power_100_edition: [{ name: "2012" }, { name: "2013" }],
          acf: {
            artist_power_100: [
              { place: 79, edition: { wordpress_id: 13, name: "2013" } },
              { place: 76, edition: { wordpress_id: 12, name: "2012" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Budi-Tek-280x280-1.jpg",
            caption: "Budi Tek. Courtesy Yuz Foundation",
            alt_text: "",
            media_details: {
              width: 1200,
              height: 1200,
              sizes: {
                thumbnail: {
                  source_url:
                    "https://backend.artreview.com/wp-content/uploads/2019/11/Budi-Tek-280x280-1-300x300.jpg",
                  width: 300,
                  height: 300,
                },
                medium: {
                  source_url:
                    "https://backend.artreview.com/wp-content/uploads/2019/11/Budi-Tek-280x280-1-600x600.jpg",
                  width: 600,
                  height: 600,
                },
                large: null,
        ...
        {
          title: "Alain Seban & Alfred Pacquement",
          path: "/artist/alain-seban-alfred-pacquement/",
          content:
          ...
          acf: {
            artist_power_100: [
              { place: 12, edition: { wordpress_id: 13, name: "2013" } },
              { place: 14, edition: { wordpress_id: 12, name: "2012" } },
            ],
          },
          featured_media: {
            source_url:
              "https://backend.artreview.com/wp-content/uploads/2019/11/Alain-Seban-Alfred-Pacquement-280x280-1.jpg",
            caption:
              "Alain Seban & Alfred Pacquement. Seban: Photo: Loic Venance/AFP. Pacquement: © Hervé Véronèse/Centre Pompidou",
            alt_text: "",
            media_details: {
              width: 280,
              height: 280,
          ...
          _highlightResult: {
            title: {
              value: "Alain Seban & Alfred Pacquement",
              matchLevel: "none",
              matchedWords: [],
            },
          },
      ...
      facets: {
        title: {
          ...
          "Agnes Gund": 1,
          "Ai Weiwei": 1,
          "Alain Seban & Alfred Pacquement": 1,
      ...
      query: "",
      params:
        "highlightPreTag=%3Cais-highlight-0000000000%3E&highlightPostTag=%3C%2Fais-highlight-0000000000%3E&facetFilters=%5B%22power_100_edition.name%3A2013%22%5D&hitsPerPage=100&facets=%5B%22title%22%2C%22artist_category.name%22%2C%22power_100_edition.name%22%2C%22nationality.name%22%5D&tagFilters=",
